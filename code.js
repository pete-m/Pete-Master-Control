(function() {
    ...
    function ignite() {
        ...
        if (!initBtn) {
            setTimeout(ignite, 100); // Wait and try again
            return;
        }
        ...
        log("<b class='text-white'>[ONLINE] Logic Handlers Attached.</b>");
    }
    ...
    async function batchInit() {
        ...
        if(!user) return log("Auth failed.");
